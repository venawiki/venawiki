...
<div class="nation-card" style="--nation-main: #801029; --nation-accent: #CD9C48;">
  ...
  <details class="nation-fold">
    ...
    <div class="nation-row">
      <div class="nation-key">시간대</div>
      <div class="nation-value">표준 시간대</div>
    </div>

    <div class="nation-row">
      <div class="nation-key">도량형</div>
      <div class="nation-value">도량형 체계</div>
    </div>

    <div class="nation-row">
      <div class="nation-key">기년법</div>
      <div class="nation-value">사용하는 기년법</div>
    </div>
  </details>

  <details class="nation-fold">
    <summary>
      <span class="nation-fold-title">외교</span>
      <span class="nation-fold-button">[ 펼치기 · 접기 ]</span>
    </summary>

    <div class="nation-row">
      <div class="nation-key">수교국</div>
      <div class="nation-value">수교국 정보</div>
    </div>

    <div class="nation-row">
      <div class="nation-key">국제기구</div>
      <div class="nation-value">가입 국제기구</div>
    </div>
  </details>

  <details class="nation-fold">
    <summary>
      <span class="nation-fold-title">국가코드</span>
      <span class="nation-fold-button">[ 펼치기 · 접기 ]</span>
    </summary>

    <div class="nation-row">
      <div class="nation-key">국가코드</div>
      <div class="nation-value">코드</div>
    </div>

    <div class="nation-row">
      <div class="nation-key">인터넷 도메인</div>
      <div class="nation-value">.xx</div>
    </div>

    <div class="nation-row">
      <div class="nation-key">국제전화</div>
      <div class="nation-value">+000</div>
    </div>
  </details>

  <div class="nation-section-title">여행정보</div>

  <div class="nation-row">
    <div class="nation-key">무비자</div>
    <div class="nation-value">무비자 입국 가능 지역</div>
  </div>

  <div class="nation-row">
    <div class="nation-key">여행유의</div>
    <div class="nation-value">여행유의 지역</div>
  </div>
...
대원명국의 정치체제와 정부 구조를 설명한다.

## 지리

대원명국의 영토와 자연환경을 설명한다.
